        ...
        <div class="col">
            <div class="col-1-1 mt-1">
                ...
                <p>Für wichtige Änderungen etwa beim Angebotsumfang oder bei technisch notwendigen Änderungen nutzen wir
                    die bei der Registrierung angegebene E-Mail-Adresse, um Sie auf diesem Wege zu informieren.</p>
                ...
                <p>Die bei der Registrierung erfassten Daten werden von uns gespeichert, solange Sie auf unserer Website
                    registriert sind und werden anschließend gelöscht. Gesetzliche Aufbewahrungsfristen bleiben
                    unberührt.</p>
                ...
                <h3>Verarbeiten von Daten (Kundendaten)</h3>
                <p>Wir verarbeiten das öffentlich zugängliche Profil von Kunden auf playoverwatch.com mit zuhilfename
                    einer API um mit diesen Daten Statisken auf dieser Webseite anzuzeigen.</p>
            </div>
            <div>
@endsection
